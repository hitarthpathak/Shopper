...
function Kids_Category({ category }) {
    ...
    return (
        ...
        <div className={`kids-category-box flex-grow h-full w-full p-5 ${light_mode ? "bg-gray-100" : "bg-gray-300"}`}>

            <div className="banner">

                <img className="rounded-lg h-auto w-auto m-auto my-7" src={Kids_Banner} alt="Image Not Available" />
